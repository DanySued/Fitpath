...
export const PATH_DATA: Record<string, PathDetail> = {
  ...
  "running": {
    ...
    icon: "🏃",
    tasks: [
      { id: 1, title: "Start with walk/run intervals", desc: "Alternate 1 minute running with 2 minutes walking for 20 minutes, 3× per week" },
  ...
  "yoga": {
    ...
    tasks: [
      ...
      { id: 2, title: "Build flexibility", desc: "Hold stretches longer, practice gentle flows 3× per week" },
